<br>
<h1 class='text-info'>REGISTER AIR OWNER HERE!</h1>
<br>
...
if (isset($_POST['register'])) {
    ...
    $acquery = "insert into airowner (OWNER_ID,AIR_NAME,COMPANY,CONTACT,MAX_COUNTER) values ('$id','$owner','$company','$contact','$maxcounter')";

    if (mysqli_query($con, $loginquery) && mysqli_query($con, $acquery)) {
        echo "<script>alert('Successfully Registered AIR OWNER ID( $id ).')</script>";
    } else {
