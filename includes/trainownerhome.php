...
<?php
$query = "SELECT * FROM trainowner WHERE OWNER_ID='$user_id'";
...
$owner = $row['TRAIN_NAME'] == '' ? "NOT FOUND <a class='badge badge-danger' href='all/settings.php'>UPDATE</a>" : $row['TRAIN_NAME'];
echo "
