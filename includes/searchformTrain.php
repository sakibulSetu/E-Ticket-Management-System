<br>
<form action="indexTrain.php" target="_self" enctype="multipart/form-data" method="POST" class="animate__animated animate__slideInRight animate__fast" id="searchform">
    <div class="col">
    ...
    <br><button type="submit" class="btn btn-outline-primary" value="SEARCH" name="search">SEARCH Trains</button><br>
</form>
<br>
